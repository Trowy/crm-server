...
public class CityServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -3306813969749270799L;
		...
		if (request.getSession().getAttribute("employee_id") != null) {
			try {
				...
				if (e3.getRole() == 'S') {
					...
					case "new":
						City c = new City(0, request.getParameter("name"), Integer.parseInt(request
								.getParameter("code")), Integer.parseInt(request.getParameter("time_zone")));
						s.addCity(c);
						break;
					case "edit":
						City c1 = new City(Integer.parseInt(request.getParameter("id")), request.getParameter("name"),
								Integer.parseInt(request.getParameter("code")), Integer.parseInt(request
										.getParameter("time_zone")));
						s.editCity(c1);
						break;
					case "delete":
