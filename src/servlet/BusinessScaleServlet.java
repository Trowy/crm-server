...
public class BusinessScaleServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -590023624228761703L;
		...
		if (request.getSession().getAttribute("employee_id") != null) {
			try {
				...
				if (e3.getRole() == 'S') {
					...
					case "new":
						BusinessScale e = new BusinessScale(0, request.getParameter("name"),
								request.getParameter("info"));
						s.addBusinessScale(e);
						break;
					case "edit":
						BusinessScale e_e = new BusinessScale(Integer.parseInt(request.getParameter("id")),
