...
public class CompanyServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -8280118404222665258L;
		...
		if (request.getSession().getAttribute("employee_id") != null) {
			try {
				...
				case "new":
					...
					Company c = new Company(0, request.getParameter("name"), request.getParameter("info"),
							request.getParameter("site"),
							p,// phones,
							em, sk, new City(Integer.parseInt(request.getParameter("City")), "", 0, 0), new Segment(
									Integer.parseInt(request.getParameter("Segment")), "", ""), new CompanyStatus(
									Integer.parseInt(request.getParameter("CompanyStatus")), "", ""),
							new BusinessScale(Integer.parseInt(request.getParameter("BusinessScale")), "", ""),
							new Employee(e_id, "", "", "", "", "", 'S', ""), t);
				...
				case "edit":
					...
					Company c_c = new Company(Integer.parseInt(request.getParameter("id")),
							request.getParameter("name"), request.getParameter("info"), request.getParameter("site"),
							p, em, sk, new City(Integer.parseInt(request.getParameter("City")), "", 0, 0), new Segment(
									Integer.parseInt(request.getParameter("Segment")), "", ""), new CompanyStatus(
									Integer.parseInt(request.getParameter("CompanyStatus")), "", ""),
							new BusinessScale(Integer.parseInt(request.getParameter("BusinessScale")), "", ""),
							new Employee(e_id, "", "", "", "", "", 'S', ""), new ArrayList<Tag>());
					s.editCompany(c_c);

					break;
				case "delete":
					s.removeTags(Integer.parseInt(request.getParameter("id")));
