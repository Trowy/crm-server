...
public class CompanyStatusServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -3659700903169084272L;
		...
		if (request.getSession().getAttribute("employee_id") != null) {
			try {
				...
				if (e3.getRole() == 'S') {
					...
					case "new":
						CompanyStatus e = new CompanyStatus(0, request.getParameter("name"),
					...
					case "edit":
						...
						CompanyStatus e_e = new CompanyStatus(Integer.parseInt(request.getParameter("id")),
