...
public class ContractorServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -5502870268058595935L;
		...
		if (request.getSession().getAttribute("employee_id") != null) {
			try {
				...
				case "new":
					...
					Contractor contractor = new Contractor(0, request.getParameter("first_name"),
							request.getParameter("middle_name"), request.getParameter("last_name"),
							request.getParameter("info"), p, e, sk);
				...
				case "edit":
					...
					Contractor contractor_1 = new Contractor(Integer.parseInt(request.getParameter("id")),
							...
							request.getParameter("last_name"), request.getParameter("info"), p, e, sk);
